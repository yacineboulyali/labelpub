...
(function( root, window, document, factory, undefined) {
    ...
    function initialise(containerSelector, options) {
        ...
        /**
         * Turns app to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        ...
        function displayWarnings(){
            if(!isOK){
                ...
                showError('error', 'https://github.com/alvarotrigo/app#options.');
            }
            ...
            if(options.scrollOverflow && options.scrollOverflowHandler == null){
                ...
                showError('error', 'The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before app.');
            }
    ...
    function showError(type, text){
        window.console && window.console[type] && window.console[type]('app: ' + text);
    }
